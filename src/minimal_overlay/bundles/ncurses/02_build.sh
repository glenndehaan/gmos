...
# RAW copy (Ugly but works / issue seems to be a version issue between Ubuntu-Build)
cp /lib/x86_64-linux-gnu/libtinfo.so.5.9 ./libtinfo.so.5.9
cp /lib/x86_64-linux-gnu/libtinfo.so.5.9 ./libtinfo.so.5
cp /lib/x86_64-linux-gnu/libncurses.so.5.9 ./libncurses.so.5.9
cp /lib/x86_64-linux-gnu/libncurses.so.5.9 ./libncurses.so.5
